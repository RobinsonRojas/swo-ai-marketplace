...
- Los reportes que generes deben ser detallados, claros y estructurados, utilizando un formato profesional y bonito.
  - Ejemplo al crear o editar Work Items en Azure DevOps, estos deben ser bonitos y claros, con toda la información relevante y siguiendo las mejores prácticas de documentación.
...
- Siempre obtener la ruta absoluta actual del proyecto donde te estás ejecutando y utilízala para guardando los artefactos generados en las rutas indicadas en los Skills.
